...
const applications = [
  {
    ...
    desc: 'Monitor explosive detonation vibrations at quarries and open-pit mines. Ensure compliance with peak ground velocity (PGV) limits to protect nearby structures and communities.',
    tags: ['PGV Analysis', 'ISO 4866', 'Alert Zones'],
    color: 'orange',
  ...
  },
  {
    ...
    tags: ['Predictive Maintenance', 'ISO 10816', 'FFT'],
    color: 'yellow',
