...
const techItems = [
  {
    ...
    desc: 'RP2040 dual-core ARM Cortex-M0+ @ 133MHz with integrated Wi-Fi 802.11n. Reads the ADXL345 via SPI, timestamps samples, and transmits data wirelessly. Built-in 12-bit ADC at 500 ksps.',
    icon: Cpu,
    color: 'from-red-500/20 to-red-500/5',
    border: 'border-red-500/30',
    iconColor: 'text-red-400',
    specs: ['133 MHz', '264KB SRAM', 'Wi-Fi 2.4GHz', 'SPI/I²C/UART'],
  },
  {
    name: 'ADXL345',
    category: '3-Axis Accelerometer',
    desc: 'Analog Devices low-power digital accelerometer with SPI/I²C interface. No external ADC required — digitization is built in. Selectable measurement range from ±2g to ±16g with 13-bit resolution.',
    icon: Activity,
    color: 'from-blue-500/20 to-blue-500/5',
    border: 'border-blue-500/30',
    iconColor: 'text-blue-400',
    specs: ['±2g–±16g', '13-bit', 'SPI/I²C', '3 axes'],
  },
  {
    name: 'MicroSD Module',
